...
output_file_path = "mandrill_t94_u8be-3x512x512.raw"
...
for i in range(0, len(image_data), 3):
    ...
    # Set the least significant bit of the green component to 1
    green_byte |= 0x01  # Set the LSB to 1 (00000001 in binary)
...
print("Image with LSBs of green component set to 1 saved as 'mandrill_t94_u8be-3x512x512.raw'.")
